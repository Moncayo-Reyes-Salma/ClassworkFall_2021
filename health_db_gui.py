...
def load_and_reszie_image(filename):
    pil_image = Image.open("images/IMG_0023 (1).jpg")
...
def design_window():
    ...
    name_entry_box = ttk.Entry(root, width=10, textvariable=id_data)
    name_entry_box.grid(column=1, row=2, sticky="w")
    ...
    def change_picture_cmd():
        filename = filedialog.askopenfilename(initdir="images")
    ...
    change_picture_btn.grid(column=1, row=2)
    root.mainloop()
